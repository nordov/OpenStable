      ...
      <div className="splash-featured-full-container">
        <div className="splash-featured-inner-container">
            ...
            <ul className="featured-random-ul">
              <div className="featured-li-ele featured-li-ele-first">
                <li id="featured-first-img">
                  ...
                  <Link className="overlay city-picture-text-link" to="/bayarea" to="/bayarea">
                ...
                <li>
                  ...
                  <Link className="overlay city-picture-text-link" to="/bayarea">
          ...
          <div className="splash-featured-text-container">
            <div>
              <Link className="city-text-link" to="/bayarea"><p>Marin Headlands</p></Link>
              <Link className="city-text-link" to="/bayarea"><p>Mill Valley / San Rafael</p></Link>
            </div>
            <div>
              <Link className="city-text-link" to="/bayarea"><p>Richmond / San Pablo</p></Link>
              <Link className="city-text-link" to="/bayarea"><p>Oakland Hills / Tilden</p></Link>
            </div>
            <div>
              <Link className="city-text-link" to="/bayarea"><p>Alemeda / Hayward</p></Link>
              <Link className="city-text-link" to="/bayarea"><p>South San Francisco</p></Link>
            </div>
            <div>
              <Link className="city-text-link" to="/bayarea"><p>Daly City / Merced</p></Link>
              <Link className="city-text-link" to="/bayarea"><p>Golden Gate Park</p></Link>
            </div>
          </div>
        </div>
      </div>
